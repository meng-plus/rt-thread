 ...
 *      DEFINES
 *********************/
#define MY_CLASS &spinbox_ex_class
...
static void spinbox_ex_constructor(const lv_obj_class_t *class_p, lv_obj_t *obj);
static void spinbox_ex_event(const lv_obj_class_t *class_p, lv_event_t *e);
static void spinbox_ex_updatevalue(lv_obj_t *obj);

/**********************
 *  STATIC VARIABLES
 **********************/
const lv_obj_class_t spinbox_ex_class = {
    .constructor_cb = spinbox_ex_constructor,
    .event_cb = spinbox_ex_event,
    .width_def = LV_DPI_DEF,
    .instance_size = sizeof(spinbox_ex_t),
...
void spinbox_ex_set_value(lv_obj_t *obj, int32_t i)
{
    ...
    spinbox_ex_t *spinbox = (spinbox_ex_t *)obj;
...
void spinbox_ex_set_digit_format(lv_obj_t *obj, uint8_t digit_count, uint8_t separator_position)
{
    ...
    if (digit_count > SPINBOX_EX_MAX_DIGIT_COUNT)
        digit_count = SPINBOX_EX_MAX_DIGIT_COUNT;
...
static void spinbox_ex_updatevalue(lv_obj_t *obj)
{
    ...
    char buf[SPINBOX_EX_MAX_DIGIT_COUNT + 8];
    ...
    int32_t i;
    char digits[SPINBOX_EX_MAX_DIGIT_COUNT + 4];
